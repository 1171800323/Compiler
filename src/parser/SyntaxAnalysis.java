...
//
//    public void items() {
//        Set<Item> startItemSet = getClosure(new LinkedHashSet<>(Collections.singletonList(START_ITEM)));
//        int index = 0;  // 项目集编号从0开始
//        ItemSet startClosure = new ItemSet(startItemSet, index);
//        itemSets.add(startClosure);
//
//        Set<ItemSet> tempItemSet = new LinkedHashSet<>();
//        tempItemSet.add(startClosure);
//
//        index++;
//
//        Set<String> characters = new LinkedHashSet<>(nonTerminators);
